; ModuleID = 'D:/flyback_controller/hls/PI_compensator_diff/external_ref/.autopilot/db/a.o.2.bc'
...
_ifconv:
  ...
  %v_ref_read = call float @_ssdm_op_Read.ap_none.float(float %v_ref) nounwind
  ...
  call void (...)* @_ssdm_op_SpecInterface(float %v_ref, [8 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
