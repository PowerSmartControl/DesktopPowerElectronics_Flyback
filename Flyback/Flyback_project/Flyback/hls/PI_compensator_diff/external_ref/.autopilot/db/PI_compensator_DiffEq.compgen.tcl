...
set id 0
set name PI_compensator_DiffEq_faddfsub_32ns_32ns_32_5_full_dsp
...
set id 1
set name PI_compensator_DiffEq_fmul_32ns_32ns_32_4_max_dsp
...
set id 3
set name PI_compensator_DiffEq_sitofp_32ns_32_6
...
set id 4
set name PI_compensator_DiffEq_fcmp_32ns_32ns_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 5 \
			corename PI_compensator_DiffEq_AXILiteS_axilite \
			name PI_compensator_DiffEq_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler PI_compensator_DiffEq_AXILiteS_s_axi
}
