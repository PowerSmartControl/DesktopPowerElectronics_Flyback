...
`timescale 1ns/1ps
module PI_compensator_DiffEq_AXILiteS_s_axi
#(parameter
...
//------------------------Parameter----------------------
localparam
    ADDR_X_MAX_DATA_0     = 7'h10,
    ADDR_X_MAX_CTRL       = 7'h14,
    ADDR_B0_DATA_0        = 7'h18,
    ADDR_B0_CTRL          = 7'h1c,
    ADDR_B1_DATA_0        = 7'h20,
    ADDR_B1_CTRL          = 7'h24,
    ADDR_YVMEASDBG_DATA_0 = 7'h28,
    ADDR_YVMEASDBG_CTRL   = 7'h2c,
    ADDR_YDBG_DATA_0      = 7'h30,
    ADDR_YDBG_CTRL        = 7'h34,
    ADDR_EDBG_DATA_0      = 7'h38,
    ADDR_EDBG_CTRL        = 7'h3c,
    ADDR_UDBG_DATA_0      = 7'h40,
    ADDR_UDBG_CTRL        = 7'h44,
    WRIDLE                = 2'd0,
    WRDATA                = 2'd1,
    WRRESP                = 2'd2,
    RDIDLE                = 2'd0,
