...
architecture behave of PI_compensator_DiffEq_AXILiteS_s_axi is
    ...
    constant ADDR_X_MAX_DATA_0     : INTEGER := 16#10#;
    constant ADDR_X_MAX_CTRL       : INTEGER := 16#14#;
    constant ADDR_B0_DATA_0        : INTEGER := 16#18#;
    constant ADDR_B0_CTRL          : INTEGER := 16#1c#;
    constant ADDR_B1_DATA_0        : INTEGER := 16#20#;
    constant ADDR_B1_CTRL          : INTEGER := 16#24#;
    constant ADDR_YVMEASDBG_DATA_0 : INTEGER := 16#28#;
    constant ADDR_YVMEASDBG_CTRL   : INTEGER := 16#2c#;
    constant ADDR_YDBG_DATA_0      : INTEGER := 16#30#;
    constant ADDR_YDBG_CTRL        : INTEGER := 16#34#;
    constant ADDR_EDBG_DATA_0      : INTEGER := 16#38#;
    constant ADDR_EDBG_CTRL        : INTEGER := 16#3c#;
    constant ADDR_UDBG_DATA_0      : INTEGER := 16#40#;
    constant ADDR_UDBG_CTRL        : INTEGER := 16#44#;
