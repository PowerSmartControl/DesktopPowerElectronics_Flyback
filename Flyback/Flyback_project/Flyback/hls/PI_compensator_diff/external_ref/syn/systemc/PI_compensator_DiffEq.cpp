...
PI_compensator_DiffEq::PI_compensator_DiffEq(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    PI_compensator_DiffEq_faddfsub_32ns_32ns_32_5_full_dsp_U0->din0(grp_fu_149_p0);
    PI_compensator_DiffEq_faddfsub_32ns_32ns_32_5_full_dsp_U0->din1(grp_fu_149_p1);
    PI_compensator_DiffEq_faddfsub_32ns_32ns_32_5_full_dsp_U0->opcode(grp_fu_149_opcode);
    PI_compensator_DiffEq_faddfsub_32ns_32ns_32_5_full_dsp_U0->ce(grp_fu_149_ce);
    PI_compensator_DiffEq_faddfsub_32ns_32ns_32_5_full_dsp_U0->dout(grp_fu_149_p2);
    ...
    PI_compensator_DiffEq_fmul_32ns_32ns_32_4_max_dsp_U1->din0(e0_loc_reg_481);
    PI_compensator_DiffEq_fmul_32ns_32ns_32_4_max_dsp_U1->din1(b0);
    PI_compensator_DiffEq_fmul_32ns_32ns_32_4_max_dsp_U1->ce(grp_fu_154_ce);
    PI_compensator_DiffEq_fmul_32ns_32ns_32_4_max_dsp_U1->dout(grp_fu_154_p2);
    ...
    PI_compensator_DiffEq_fmul_32ns_32ns_32_4_max_dsp_U2->din1(b1);
    PI_compensator_DiffEq_fmul_32ns_32ns_32_4_max_dsp_U2->ce(grp_fu_159_ce);
    PI_compensator_DiffEq_fmul_32ns_32ns_32_4_max_dsp_U2->dout(grp_fu_159_p2);
    ...
    PI_compensator_DiffEq_sitofp_32ns_32_6_U3->din0(grp_fu_164_p0);
    PI_compensator_DiffEq_sitofp_32ns_32_6_U3->ce(grp_fu_164_ce);
    PI_compensator_DiffEq_sitofp_32ns_32_6_U3->dout(grp_fu_164_p1);
    ...
    PI_compensator_DiffEq_fcmp_32ns_32ns_1_1_U4->din0(grp_fu_167_p0);
    PI_compensator_DiffEq_fcmp_32ns_32ns_1_1_U4->din1(grp_fu_167_p1);
    PI_compensator_DiffEq_fcmp_32ns_32ns_1_1_U4->opcode(grp_fu_167_opcode);
    PI_compensator_DiffEq_fcmp_32ns_32ns_1_1_U4->dout(grp_fu_167_p2);
    ...
    sensitive << ( reg_172 );
    sensitive << ( ap_sig_cseq_ST_st26_fsm_25 );
    sensitive << ( tmp_5_fu_244_p3 );
    sensitive << ( ap_sig_cseq_ST_st27_fsm_26 );

    SC_METHOD(thread_grp_fu_167_p1);
    sensitive << ( ap_sig_cseq_ST_st26_fsm_25 );
    sensitive << ( tmp_6_reg_533 );
    sensitive << ( ap_sig_cseq_ST_st27_fsm_26 );

    SC_METHOD(thread_isNeg_fu_385_p3);
    sensitive << ( sh_assign_fu_379_p2 );

    SC_METHOD(thread_loc_V_1_fu_359_p1);
    sensitive << ( p_Val2_s_fu_345_p1 );

    SC_METHOD(thread_loc_V_fu_349_p4);
    sensitive << ( p_Val2_s_fu_345_p1 );

    SC_METHOD(thread_notlhs3_fu_287_p2);
    sensitive << ( ap_sig_cseq_ST_st27_fsm_26 );
    sensitive << ( tmp_11_fu_256_p4 );

    SC_METHOD(thread_notlhs5_fu_305_p2);
    sensitive << ( ap_sig_cseq_ST_st27_fsm_26 );
    sensitive << ( tmp_13_fu_273_p4 );

    SC_METHOD(thread_notlhs_fu_220_p2);
    sensitive << ( ap_sig_cseq_ST_st26_fsm_25 );
    sensitive << ( tmp_4_fu_206_p4 );

    SC_METHOD(thread_notrhs4_fu_293_p2);
    sensitive << ( ap_sig_cseq_ST_st27_fsm_26 );
    sensitive << ( tmp_12_fu_266_p1 );

    SC_METHOD(thread_notrhs6_fu_311_p2);
    sensitive << ( ap_sig_cseq_ST_st27_fsm_26 );
    sensitive << ( tmp_14_fu_283_p1 );

    SC_METHOD(thread_notrhs_fu_226_p2);
    sensitive << ( ap_sig_cseq_ST_st26_fsm_25 );
    sensitive << ( tmp_7_fu_216_p1 );

    SC_METHOD(thread_p_Result_s_fu_363_p3);
    sensitive << ( loc_V_1_fu_359_p1 );

    SC_METHOD(thread_p_Val2_s_fu_345_p1);
    sensitive << ( x_assign_fu_333_p3 );

    SC_METHOD(thread_sh_assign_1_cast_cast_fu_415_p1);
    sensitive << ( sh_assign_1_fu_403_p3 );

    SC_METHOD(thread_sh_assign_1_cast_fu_411_p1);
    sensitive << ( sh_assign_1_fu_403_p3 );

    SC_METHOD(thread_sh_assign_1_fu_403_p3);
    sensitive << ( isNeg_fu_385_p3 );
    sensitive << ( sh_assign_fu_379_p2 );
    sensitive << ( tmp_4_i_i_cast_fu_399_p1 );

    SC_METHOD(thread_sh_assign_fu_379_p2);
    sensitive << ( tmp_i_i_i_cast1_fu_375_p1 );

    SC_METHOD(thread_tmp_10_fu_238_p2);
    sensitive << ( grp_fu_167_p2 );
    sensitive << ( tmp_8_fu_232_p2 );

    SC_METHOD(thread_tmp_11_fu_256_p4);
    sensitive << ( tmp_5_to_int_fu_252_p1 );

    SC_METHOD(thread_tmp_12_fu_266_p1);
    sensitive << ( tmp_5_to_int_fu_252_p1 );

    SC_METHOD(thread_tmp_13_fu_273_p4);
    sensitive << ( tmp_6_to_int_fu_270_p1 );

    SC_METHOD(thread_tmp_14_fu_283_p1);
    sensitive << ( tmp_6_to_int_fu_270_p1 );

    SC_METHOD(thread_tmp_15_fu_299_p2);
    sensitive << ( notrhs4_fu_293_p2 );
    sensitive << ( notlhs3_fu_287_p2 );

    SC_METHOD(thread_tmp_16_fu_317_p2);
    sensitive << ( notrhs6_fu_311_p2 );
    sensitive << ( notlhs5_fu_305_p2 );

    SC_METHOD(thread_tmp_17_fu_323_p2);
    sensitive << ( tmp_15_fu_299_p2 );
    sensitive << ( tmp_16_fu_317_p2 );

    SC_METHOD(thread_tmp_19_fu_329_p2);
    sensitive << ( tmp_17_reg_545 );
    sensitive << ( tmp_18_reg_550 );

    SC_METHOD(thread_tmp_20_fu_453_p1);
    sensitive << ( tmp_25_reg_560 );

    SC_METHOD(thread_tmp_22_fu_456_p3);
    sensitive << ( isNeg_reg_555 );
    sensitive << ( tmp_21_reg_565 );
    sensitive << ( tmp_20_fu_453_p1 );

    SC_METHOD(thread_tmp_2_i_i_fu_371_p1);
    sensitive << ( p_Result_s_fu_363_p3 );

    SC_METHOD(thread_tmp_3_to_int_fu_202_p1);
    sensitive << ( reg_172 );

    SC_METHOD(thread_tmp_4_fu_206_p4);
    sensitive << ( tmp_3_to_int_fu_202_p1 );

    SC_METHOD(thread_tmp_4_i_i_cast_fu_399_p1);
    sensitive << ( tmp_4_i_i_fu_393_p2 );

    SC_METHOD(thread_tmp_4_i_i_fu_393_p2);
    sensitive << ( loc_V_fu_349_p4 );

    SC_METHOD(thread_tmp_5_fu_244_p3);
    sensitive << ( reg_172 );
    sensitive << ( tmp_10_reg_528 );

    SC_METHOD(thread_tmp_5_to_int_fu_252_p1);
    sensitive << ( tmp_5_fu_244_p3 );

    SC_METHOD(thread_tmp_6_i_i_fu_419_p1);
    sensitive << ( sh_assign_1_cast_fu_411_p1 );

    SC_METHOD(thread_tmp_6_to_int_fu_270_p1);
    sensitive << ( tmp_6_reg_533 );

    SC_METHOD(thread_tmp_7_fu_216_p1);
    sensitive << ( tmp_3_to_int_fu_202_p1 );

    SC_METHOD(thread_tmp_7_i_i_fu_423_p2);
    sensitive << ( p_Result_s_fu_363_p3 );
    sensitive << ( sh_assign_1_cast_cast_fu_415_p1 );

    SC_METHOD(thread_tmp_8_fu_232_p2);
    sensitive << ( notrhs_fu_226_p2 );
    sensitive << ( notlhs_fu_220_p2 );

    SC_METHOD(thread_tmp_9_i_i_fu_429_p2);
    sensitive << ( tmp_2_i_i_fu_371_p1 );
    sensitive << ( tmp_6_i_i_fu_419_p1 );

    SC_METHOD(thread_tmp_fu_193_p1);
    sensitive << ( X_MAX_read_reg_498 );

    SC_METHOD(thread_tmp_i_i_i_cast1_fu_375_p1);
    sensitive << ( loc_V_fu_349_p4 );

    SC_METHOD(thread_u);
    sensitive << ( tmp_22_fu_456_p3 );
    sensitive << ( ap_sig_cseq_ST_st29_fsm_28 );
    ...
    SC_METHOD(thread_x_assign_fu_333_p3);
    sensitive << ( tmp_6_reg_533 );
    sensitive << ( tmp_5_reg_540 );
    sensitive << ( tmp_19_fu_329_p2 );

    SC_METHOD(thread_y2_fu_178_p1);
    sensitive << ( v_meas );
    ...
    sc_trace(mVcdFile, X_MAX_read_reg_498, "X_MAX_read_reg_498");
    ...
    sc_trace(mVcdFile, tmp_1_reg_513, "tmp_1_reg_513");
    ...
    sc_trace(mVcdFile, tmp_10_reg_528, "tmp_10_reg_528");
    sc_trace(mVcdFile, ap_sig_cseq_ST_st26_fsm_25, "ap_sig_cseq_ST_st26_fsm_25");
    sc_trace(mVcdFile, ap_sig_bdd_197, "ap_sig_bdd_197");
    sc_trace(mVcdFile, tmp_6_reg_533, "tmp_6_reg_533");
    sc_trace(mVcdFile, tmp_5_fu_244_p3, "tmp_5_fu_244_p3");
    sc_trace(mVcdFile, tmp_5_reg_540, "tmp_5_reg_540");
    ...
    sc_trace(mVcdFile, tmp_18_reg_550, "tmp_18_reg_550");
    sc_trace(mVcdFile, isNeg_fu_385_p3, "isNeg_fu_385_p3");
    sc_trace(mVcdFile, isNeg_reg_555, "isNeg_reg_555");
    sc_trace(mVcdFile, ap_sig_cseq_ST_st28_fsm_27, "ap_sig_cseq_ST_st28_fsm_27");
    sc_trace(mVcdFile, ap_sig_bdd_220, "ap_sig_bdd_220");
    sc_trace(mVcdFile, tmp_25_reg_560, "tmp_25_reg_560");
    sc_trace(mVcdFile, tmp_21_reg_565, "tmp_21_reg_565");
    sc_trace(mVcdFile, x_assign_fu_333_p3, "x_assign_fu_333_p3");
    sc_trace(mVcdFile, tmp_22_fu_456_p3, "tmp_22_fu_456_p3");
    ...
    sc_trace(mVcdFile, tmp_3_to_int_fu_202_p1, "tmp_3_to_int_fu_202_p1");
    sc_trace(mVcdFile, tmp_4_fu_206_p4, "tmp_4_fu_206_p4");
    ...
    sc_trace(mVcdFile, tmp_5_to_int_fu_252_p1, "tmp_5_to_int_fu_252_p1");
    sc_trace(mVcdFile, tmp_6_to_int_fu_270_p1, "tmp_6_to_int_fu_270_p1");
    sc_trace(mVcdFile, tmp_11_fu_256_p4, "tmp_11_fu_256_p4");
    sc_trace(mVcdFile, tmp_12_fu_266_p1, "tmp_12_fu_266_p1");
    sc_trace(mVcdFile, notrhs4_fu_293_p2, "notrhs4_fu_293_p2");
    sc_trace(mVcdFile, notlhs3_fu_287_p2, "notlhs3_fu_287_p2");
    sc_trace(mVcdFile, tmp_13_fu_273_p4, "tmp_13_fu_273_p4");
    sc_trace(mVcdFile, tmp_14_fu_283_p1, "tmp_14_fu_283_p1");
    sc_trace(mVcdFile, notrhs6_fu_311_p2, "notrhs6_fu_311_p2");
    sc_trace(mVcdFile, notlhs5_fu_305_p2, "notlhs5_fu_305_p2");
    ...
    sc_trace(mVcdFile, p_Val2_s_fu_345_p1, "p_Val2_s_fu_345_p1");
    sc_trace(mVcdFile, loc_V_1_fu_359_p1, "loc_V_1_fu_359_p1");
    sc_trace(mVcdFile, p_Result_s_fu_363_p3, "p_Result_s_fu_363_p3");
    sc_trace(mVcdFile, loc_V_fu_349_p4, "loc_V_fu_349_p4");
    sc_trace(mVcdFile, tmp_i_i_i_cast1_fu_375_p1, "tmp_i_i_i_cast1_fu_375_p1");
    sc_trace(mVcdFile, sh_assign_fu_379_p2, "sh_assign_fu_379_p2");
    sc_trace(mVcdFile, tmp_4_i_i_fu_393_p2, "tmp_4_i_i_fu_393_p2");
    sc_trace(mVcdFile, tmp_4_i_i_cast_fu_399_p1, "tmp_4_i_i_cast_fu_399_p1");
    sc_trace(mVcdFile, sh_assign_1_fu_403_p3, "sh_assign_1_fu_403_p3");
    sc_trace(mVcdFile, sh_assign_1_cast_fu_411_p1, "sh_assign_1_cast_fu_411_p1");
    sc_trace(mVcdFile, sh_assign_1_cast_cast_fu_415_p1, "sh_assign_1_cast_cast_fu_415_p1");
    sc_trace(mVcdFile, tmp_2_i_i_fu_371_p1, "tmp_2_i_i_fu_371_p1");
    sc_trace(mVcdFile, tmp_6_i_i_fu_419_p1, "tmp_6_i_i_fu_419_p1");
    sc_trace(mVcdFile, tmp_7_i_i_fu_423_p2, "tmp_7_i_i_fu_423_p2");
    sc_trace(mVcdFile, tmp_9_i_i_fu_429_p2, "tmp_9_i_i_fu_429_p2");
...
void PI_compensator_DiffEq::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st12_fsm_11.read())) {
        X_MAX_read_reg_498 = X_MAX.read();
        e0 = e0_loc_reg_481.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st11_fsm_10.read())) {
        e0_loc_reg_481 = grp_fu_149_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st28_fsm_27.read())) {
        isNeg_reg_555 = sh_assign_fu_379_p2.read().range(8, 8);
        tmp_21_reg_565 = tmp_9_i_i_fu_429_p2.read().range(32, 23);
        tmp_25_reg_560 = tmp_7_i_i_fu_423_p2.read().range(23, 23);
        x0 = x_assign_fu_333_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st20_fsm_19.read()) || esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st25_fsm_24.read()))) {
        reg_172 = grp_fu_149_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st26_fsm_25.read())) {
        tmp_10_reg_528 = tmp_10_fu_238_p2.read();
        tmp_6_reg_533 = grp_fu_164_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st27_fsm_26.read())) {
        tmp_17_reg_545 = tmp_17_fu_323_p2.read();
        tmp_18_reg_550 = grp_fu_167_p2.read();
        tmp_5_reg_540 = tmp_5_fu_244_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st15_fsm_14.read())) {
        tmp_1_reg_513 = grp_fu_159_p2.read();
        tmp_s_reg_508 = grp_fu_154_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st6_fsm_5.read())) {
        y_reg_469 = grp_fu_164_p1.read();
    }
}
...
void PI_compensator_DiffEq::thread_ap_sig_bdd_151() {
    ap_sig_bdd_151 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(10, 10));
}

void PI_compensator_DiffEq::thread_ap_sig_bdd_160() {
    ap_sig_bdd_160 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(11, 11));
}
...
void PI_compensator_DiffEq::thread_grp_fu_149_ce() {
    grp_fu_149_ce = ap_const_logic_1;
}

void PI_compensator_DiffEq::thread_grp_fu_149_opcode() {
...
void PI_compensator_DiffEq::thread_grp_fu_149_p0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st21_fsm_20.read())) {
        grp_fu_149_p0 = reg_172.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st16_fsm_15.read())) {
        grp_fu_149_p0 = tmp_s_reg_508.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st7_fsm_6.read())) {
        grp_fu_149_p0 = v_ref.read();
    } else {
        grp_fu_149_p0 =  (sc_lv<32>) ("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    }
}

void PI_compensator_DiffEq::thread_grp_fu_149_p1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st21_fsm_20.read())) {
        grp_fu_149_p1 = x0.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st16_fsm_15.read())) {
        grp_fu_149_p1 = tmp_1_reg_513.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st7_fsm_6.read())) {
        grp_fu_149_p1 = y_reg_469.read();
    } else {
        grp_fu_149_p1 =  (sc_lv<32>) ("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    }
}

void PI_compensator_DiffEq::thread_grp_fu_154_ce() {
    grp_fu_154_ce = ap_const_logic_1;
}

void PI_compensator_DiffEq::thread_grp_fu_159_ce() {
    grp_fu_159_ce = ap_const_logic_1;
}

void PI_compensator_DiffEq::thread_grp_fu_164_ce() {
    grp_fu_164_ce = ap_const_logic_1;
}

void PI_compensator_DiffEq::thread_grp_fu_164_p0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st21_fsm_20.read())) {
        grp_fu_164_p0 = tmp_fu_193_p1.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read())) {
        grp_fu_164_p0 = y2_fu_178_p1.read();
    } else {
        grp_fu_164_p0 =  (sc_lv<32>) ("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    }
}

void PI_compensator_DiffEq::thread_grp_fu_167_opcode() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st27_fsm_26.read())) {
...
void PI_compensator_DiffEq::thread_grp_fu_167_p0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st27_fsm_26.read())) {
        grp_fu_167_p0 = tmp_5_fu_244_p3.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st26_fsm_25.read())) {
        grp_fu_167_p0 = reg_172.read();
    } else {
        grp_fu_167_p0 =  (sc_lv<32>) ("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    }
}

void PI_compensator_DiffEq::thread_grp_fu_167_p1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st27_fsm_26.read())) {
        grp_fu_167_p1 = tmp_6_reg_533.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st26_fsm_25.read())) {
...
void PI_compensator_DiffEq::thread_isNeg_fu_385_p3() {
    isNeg_fu_385_p3 = sh_assign_fu_379_p2.read().range(8, 8);
}

void PI_compensator_DiffEq::thread_loc_V_1_fu_359_p1() {
    loc_V_1_fu_359_p1 = p_Val2_s_fu_345_p1.read().range(23-1, 0);
}

void PI_compensator_DiffEq::thread_loc_V_fu_349_p4() {
    loc_V_fu_349_p4 = p_Val2_s_fu_345_p1.read().range(30, 23);
}

void PI_compensator_DiffEq::thread_notlhs3_fu_287_p2() {
    notlhs3_fu_287_p2 = (!tmp_11_fu_256_p4.read().is_01() || !ap_const_lv8_FF.is_01())? sc_lv<1>(): sc_lv<1>(tmp_11_fu_256_p4.read() != ap_const_lv8_FF);
}

void PI_compensator_DiffEq::thread_notlhs5_fu_305_p2() {
    notlhs5_fu_305_p2 = (!tmp_13_fu_273_p4.read().is_01() || !ap_const_lv8_FF.is_01())? sc_lv<1>(): sc_lv<1>(tmp_13_fu_273_p4.read() != ap_const_lv8_FF);
}

void PI_compensator_DiffEq::thread_notlhs_fu_220_p2() {
    notlhs_fu_220_p2 = (!tmp_4_fu_206_p4.read().is_01() || !ap_const_lv8_FF.is_01())? sc_lv<1>(): sc_lv<1>(tmp_4_fu_206_p4.read() != ap_const_lv8_FF);
}

void PI_compensator_DiffEq::thread_notrhs4_fu_293_p2() {
    notrhs4_fu_293_p2 = (!tmp_12_fu_266_p1.read().is_01() || !ap_const_lv23_0.is_01())? sc_lv<1>(): sc_lv<1>(tmp_12_fu_266_p1.read() == ap_const_lv23_0);
}

void PI_compensator_DiffEq::thread_notrhs6_fu_311_p2() {
    notrhs6_fu_311_p2 = (!tmp_14_fu_283_p1.read().is_01() || !ap_const_lv23_0.is_01())? sc_lv<1>(): sc_lv<1>(tmp_14_fu_283_p1.read() == ap_const_lv23_0);
}

void PI_compensator_DiffEq::thread_notrhs_fu_226_p2() {
    notrhs_fu_226_p2 = (!tmp_7_fu_216_p1.read().is_01() || !ap_const_lv23_0.is_01())? sc_lv<1>(): sc_lv<1>(tmp_7_fu_216_p1.read() == ap_const_lv23_0);
}

void PI_compensator_DiffEq::thread_p_Result_s_fu_363_p3() {
    p_Result_s_fu_363_p3 = esl_concat<1,23>(ap_const_lv1_1, loc_V_1_fu_359_p1.read());
}

void PI_compensator_DiffEq::thread_p_Val2_s_fu_345_p1() {
    p_Val2_s_fu_345_p1 = x_assign_fu_333_p3.read();
}

void PI_compensator_DiffEq::thread_sh_assign_1_cast_cast_fu_415_p1() {
    sh_assign_1_cast_cast_fu_415_p1 = esl_sext<24,9>(sh_assign_1_fu_403_p3.read());
}

void PI_compensator_DiffEq::thread_sh_assign_1_cast_fu_411_p1() {
    sh_assign_1_cast_fu_411_p1 = esl_sext<32,9>(sh_assign_1_fu_403_p3.read());
}

void PI_compensator_DiffEq::thread_sh_assign_1_fu_403_p3() {
    sh_assign_1_fu_403_p3 = (!isNeg_fu_385_p3.read()[0].is_01())? sc_lv<9>(): ((isNeg_fu_385_p3.read()[0].to_bool())? tmp_4_i_i_cast_fu_399_p1.read(): sh_assign_fu_379_p2.read());
}

void PI_compensator_DiffEq::thread_sh_assign_fu_379_p2() {
    sh_assign_fu_379_p2 = (!ap_const_lv9_181.is_01() || !tmp_i_i_i_cast1_fu_375_p1.read().is_01())? sc_lv<9>(): (sc_bigint<9>(ap_const_lv9_181) + sc_biguint<9>(tmp_i_i_i_cast1_fu_375_p1.read()));
}

void PI_compensator_DiffEq::thread_tmp_10_fu_238_p2() {
    tmp_10_fu_238_p2 = (tmp_8_fu_232_p2.read() & grp_fu_167_p2.read());
}

void PI_compensator_DiffEq::thread_tmp_11_fu_256_p4() {
    tmp_11_fu_256_p4 = tmp_5_to_int_fu_252_p1.read().range(30, 23);
}

void PI_compensator_DiffEq::thread_tmp_12_fu_266_p1() {
    tmp_12_fu_266_p1 = tmp_5_to_int_fu_252_p1.read().range(23-1, 0);
}

void PI_compensator_DiffEq::thread_tmp_13_fu_273_p4() {
    tmp_13_fu_273_p4 = tmp_6_to_int_fu_270_p1.read().range(30, 23);
}

void PI_compensator_DiffEq::thread_tmp_14_fu_283_p1() {
    tmp_14_fu_283_p1 = tmp_6_to_int_fu_270_p1.read().range(23-1, 0);
}

void PI_compensator_DiffEq::thread_tmp_15_fu_299_p2() {
    tmp_15_fu_299_p2 = (notrhs4_fu_293_p2.read() | notlhs3_fu_287_p2.read());
}

void PI_compensator_DiffEq::thread_tmp_16_fu_317_p2() {
    tmp_16_fu_317_p2 = (notrhs6_fu_311_p2.read() | notlhs5_fu_305_p2.read());
}

void PI_compensator_DiffEq::thread_tmp_17_fu_323_p2() {
    tmp_17_fu_323_p2 = (tmp_15_fu_299_p2.read() & tmp_16_fu_317_p2.read());
}

void PI_compensator_DiffEq::thread_tmp_19_fu_329_p2() {
    tmp_19_fu_329_p2 = (tmp_17_reg_545.read() & tmp_18_reg_550.read());
}

void PI_compensator_DiffEq::thread_tmp_20_fu_453_p1() {
    tmp_20_fu_453_p1 = esl_zext<10,1>(tmp_25_reg_560.read());
}

void PI_compensator_DiffEq::thread_tmp_22_fu_456_p3() {
    tmp_22_fu_456_p3 = (!isNeg_reg_555.read()[0].is_01())? sc_lv<10>(): ((isNeg_reg_555.read()[0].to_bool())? tmp_20_fu_453_p1.read(): tmp_21_reg_565.read());
}

void PI_compensator_DiffEq::thread_tmp_2_i_i_fu_371_p1() {
    tmp_2_i_i_fu_371_p1 = esl_zext<62,24>(p_Result_s_fu_363_p3.read());
}

void PI_compensator_DiffEq::thread_tmp_3_to_int_fu_202_p1() {
    tmp_3_to_int_fu_202_p1 = reg_172.read();
}

void PI_compensator_DiffEq::thread_tmp_4_fu_206_p4() {
    tmp_4_fu_206_p4 = tmp_3_to_int_fu_202_p1.read().range(30, 23);
}

void PI_compensator_DiffEq::thread_tmp_4_i_i_cast_fu_399_p1() {
    tmp_4_i_i_cast_fu_399_p1 = esl_sext<9,8>(tmp_4_i_i_fu_393_p2.read());
}

void PI_compensator_DiffEq::thread_tmp_4_i_i_fu_393_p2() {
    tmp_4_i_i_fu_393_p2 = (!ap_const_lv8_7F.is_01() || !loc_V_fu_349_p4.read().is_01())? sc_lv<8>(): (sc_biguint<8>(ap_const_lv8_7F) - sc_biguint<8>(loc_V_fu_349_p4.read()));
}

void PI_compensator_DiffEq::thread_tmp_5_fu_244_p3() {
    tmp_5_fu_244_p3 = (!tmp_10_reg_528.read()[0].is_01())? sc_lv<32>(): ((tmp_10_reg_528.read()[0].to_bool())? reg_172.read(): ap_const_lv32_0);
}

void PI_compensator_DiffEq::thread_tmp_5_to_int_fu_252_p1() {
    tmp_5_to_int_fu_252_p1 = tmp_5_fu_244_p3.read();
}

void PI_compensator_DiffEq::thread_tmp_6_i_i_fu_419_p1() {
    tmp_6_i_i_fu_419_p1 = esl_zext<62,32>(sh_assign_1_cast_fu_411_p1.read());
}

void PI_compensator_DiffEq::thread_tmp_6_to_int_fu_270_p1() {
    tmp_6_to_int_fu_270_p1 = tmp_6_reg_533.read();
}

void PI_compensator_DiffEq::thread_tmp_7_fu_216_p1() {
    tmp_7_fu_216_p1 = tmp_3_to_int_fu_202_p1.read().range(23-1, 0);
}

void PI_compensator_DiffEq::thread_tmp_7_i_i_fu_423_p2() {
    tmp_7_i_i_fu_423_p2 = (!sh_assign_1_cast_cast_fu_415_p1.read().is_01())? sc_lv<24>(): p_Result_s_fu_363_p3.read() >> (unsigned short)sh_assign_1_cast_cast_fu_415_p1.read().to_uint();
}

void PI_compensator_DiffEq::thread_tmp_8_fu_232_p2() {
    tmp_8_fu_232_p2 = (notrhs_fu_226_p2.read() | notlhs_fu_220_p2.read());
}

void PI_compensator_DiffEq::thread_tmp_9_i_i_fu_429_p2() {
    tmp_9_i_i_fu_429_p2 = (!tmp_6_i_i_fu_419_p1.read().is_01())? sc_lv<62>(): tmp_2_i_i_fu_371_p1.read() << (unsigned short)tmp_6_i_i_fu_419_p1.read().to_uint();
}

void PI_compensator_DiffEq::thread_tmp_fu_193_p1() {
    tmp_fu_193_p1 = esl_zext<32,10>(X_MAX_read_reg_498.read());
}

void PI_compensator_DiffEq::thread_tmp_i_i_i_cast1_fu_375_p1() {
    tmp_i_i_i_cast1_fu_375_p1 = esl_zext<9,8>(loc_V_fu_349_p4.read());
}

void PI_compensator_DiffEq::thread_u() {
    u = tmp_22_fu_456_p3.read();
}

void PI_compensator_DiffEq::thread_uDbg() {
    uDbg = tmp_22_fu_456_p3.read();
}
...
void PI_compensator_DiffEq::thread_x_assign_fu_333_p3() {
    x_assign_fu_333_p3 = (!tmp_19_fu_329_p2.read()[0].is_01())? sc_lv<32>(): ((tmp_19_fu_329_p2.read()[0].to_bool())? tmp_5_reg_540.read(): tmp_6_reg_533.read());
}

void PI_compensator_DiffEq::thread_y2_fu_178_p1() {
    y2_fu_178_p1 = esl_zext<32,12>(v_meas.read());
}
