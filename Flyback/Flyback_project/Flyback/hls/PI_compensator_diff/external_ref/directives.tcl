...
set_directive_interface -mode ap_none "PI_compensator_DiffEq" v_ref
set_directive_interface -mode s_axilite "PI_compensator_DiffEq" b0
set_directive_interface -mode s_axilite "PI_compensator_DiffEq" b1
