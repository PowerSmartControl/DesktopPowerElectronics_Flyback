...
$(ObjDir)/digital_compensator_tb.c_pre.c.tb.o : digital_compensator_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) digital_compensator_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/digital_compensator.c_pre.c.tb.o : digital_compensator.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) digital_compensator.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
