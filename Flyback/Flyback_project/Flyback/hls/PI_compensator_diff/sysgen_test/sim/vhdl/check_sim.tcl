...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.digital_compensator.autotvin_v_ref.dat"
         "c.digital_compensator.autotvin_v_meas.dat"
         "c.digital_compensator.autotvin_Kp.dat"
         "c.digital_compensator.autotvin_Ki2.dat"
         "c.digital_compensator.autotvout_u.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.digital_compensator.autotvout_u.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
