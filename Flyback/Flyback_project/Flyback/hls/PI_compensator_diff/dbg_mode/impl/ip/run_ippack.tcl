...
set Vendor      "gfb"
set Library     "flyback"
set IPName      "PI_compensator_DiffEq"
set Version     "1.0"
set DisplayName "PI_compensator_DiffEq"
set Revision    "1603150809"
set Description "PI compensator for Flyback Board (diff eq)"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "PI_compensator_DiffEq"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 v_ref W 0x0 "Data signal of v_ref" {{0 32 v_ref W 0 "Bit 31 to 0 Data signal of v_ref"}}} {0x18 X_MAX W 0x0 "Data signal of X_MAX" {{0 10 X_MAX W 0 "Bit 9 to 0 Data signal of X_MAX"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 b0 W 0x0 "Data signal of b0" {{0 32 b0 W 0 "Bit 31 to 0 Data signal of b0"}}} {0x28 b1 W 0x0 "Data signal of b1" {{0 32 b1 W 0 "Bit 31 to 0 Data signal of b1"}}} {0x30 yVmeasDbg R 0x0 "Data signal of yVmeasDbg" {{0 32 yVmeasDbg R 0 "Bit 31 to 0 Data signal of yVmeasDbg"}}} {0x34 yVmeasDbg_ctrl R 0x0 "Control signal of yVmeasDbg" {{0 1 yVmeasDbg_ap_vld R 0 "Control signal yVmeasDbg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 yDbg R 0x0 "Data signal of yDbg" {{0 32 yDbg R 0 "Bit 31 to 0 Data signal of yDbg"}}} {0x3c yDbg_ctrl R 0x0 "Control signal of yDbg" {{0 1 yDbg_ap_vld R 0 "Control signal yDbg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 eDbg R 0x0 "Data signal of eDbg" {{0 32 eDbg R 0 "Bit 31 to 0 Data signal of eDbg"}}} {0x44 eDbg_ctrl R 0x0 "Control signal of eDbg" {{0 1 eDbg_ap_vld R 0 "Control signal eDbg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 uDbg R 0x0 "Data signal of uDbg" {{0 10 uDbg R 0 "Bit 9 to 0 Data signal of uDbg"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x4c uDbg_ctrl R 0x0 "Control signal of uDbg" {{0 1 uDbg_ap_vld R 0 "Control signal uDbg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 28 II x}
...
set enable_xo_gen 0
set kernel_files {D:/flyback_controller/hls/PI_compensator_diff/PI_compensator_DiffEq.c}
if {$enable_xo_gen} {
