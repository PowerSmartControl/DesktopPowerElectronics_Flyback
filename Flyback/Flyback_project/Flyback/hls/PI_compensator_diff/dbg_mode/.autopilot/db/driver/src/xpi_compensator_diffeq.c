...
void XPi_compensator_diffeq_Set_v_ref(XPi_compensator_diffeq *InstancePtr, u32 Data) {
    ...
    XPi_compensator_diffeq_WriteReg(InstancePtr->Axilites_BaseAddress, XPI_COMPENSATOR_DIFFEQ_AXILITES_ADDR_V_REF_DATA, Data);
}
...
u32 XPi_compensator_diffeq_Get_v_ref(XPi_compensator_diffeq *InstancePtr) {
    ...
    Data = XPi_compensator_diffeq_ReadReg(InstancePtr->Axilites_BaseAddress, XPI_COMPENSATOR_DIFFEQ_AXILITES_ADDR_V_REF_DATA);
    return Data;
}
