...
set_directive_interface -mode ap_none "Dig_compensator" u
...
set_directive_interface -mode ap_none "Dig_compensator" params.vRef
set_directive_array_partition -type complete -dim 1 "Dig_compensator" params.a
set_directive_interface -mode ap_none "Dig_compensator" params.b
set_directive_interface -mode ap_none "Dig_compensator" params.a
set_directive_array_partition -type complete -dim 1 "Dig_compensator" params.b
