...
set id 0
set name Dig_compensator_faddfsub_32ns_32ns_32_5_full_dsp
...
set id 1
set name Dig_compensator_fmul_32ns_32ns_32_4_max_dsp
...
set id 3
set name Dig_compensator_sitofp_32ns_32_6
...
set id 4
set name Dig_compensator_fcmp_32ns_32ns_1_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 5 \
			corename Dig_compensator_AXILiteS_axilite \
			name Dig_compensator_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Dig_compensator_AXILiteS_s_axi
}
