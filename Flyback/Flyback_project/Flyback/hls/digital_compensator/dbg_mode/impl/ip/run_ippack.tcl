...
set Vendor      "gfb"
set Library     "flyback"
set IPName      "Dig_compensator"
set Version     "1.0"
set DisplayName "Dig_compensator"
set Revision    "1606151629"
set Description "Digital compensator for Flyback Board"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "Dig_compensator"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 params_vRef W 0x0 "Data signal of params_vRef" {{0 32 params_vRef W 0 "Bit 31 to 0 Data signal of params_vRef"}}} {0x30 params_y_max W 0x0 "Data signal of params_y_max" {{0 32 params_y_max W 0 "Bit 31 to 0 Data signal of params_y_max"}}} {0x38 params_adcMask W 0x0 "Data signal of params_adcMask" {{0 32 params_adcMask W 0 "Bit 31 to 0 Data signal of params_adcMask"}}} {0x40 yVmeasDbg R 0x0 "Data signal of yVmeasDbg" {{0 32 yVmeasDbg R 0 "Bit 31 to 0 Data signal of yVmeasDbg"}}} {0x44 yVmeasDbg_ctrl R 0x0 "Control signal of yVmeasDbg" {{0 1 yVmeasDbg_ap_vld R 0 "Control signal yVmeasDbg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 yDbg R 0x0 "Data signal of yDbg" {{0 32 yDbg R 0 "Bit 31 to 0 Data signal of yDbg"}}} {0x4c yDbg_ctrl R 0x0 "Control signal of yDbg" {{0 1 yDbg_ap_vld R 0 "Control signal yDbg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 eDbg R 0x0 "Data signal of eDbg" {{0 32 eDbg R 0 "Bit 31 to 0 Data signal of eDbg"}}} {0x54 eDbg_ctrl R 0x0 "Control signal of eDbg" {{0 1 eDbg_ap_vld R 0 "Control signal eDbg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 uDbg R 0x0 "Data signal of uDbg" {{0 10 uDbg R 0 "Bit 9 to 0 Data signal of uDbg"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x5c uDbg_ctrl R 0x0 "Control signal of uDbg" {{0 1 uDbg_ap_vld R 0 "Control signal uDbg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "params_coef {base_address 32 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
set enable_xo_gen 0
set kernel_files {D:/flyback_controller/hls/digital_compensator/digital_compensator.c}
if {$enable_xo_gen} {
