...
if {[file isfile digital_compensator.autotvin.dat]} {
	file delete -force digital_compensator.autotvin.dat
}

if {[file isfile digital_compensator.autotvout.dat]} {
	file delete -force digital_compensator.autotvout.dat
}
