proc create_ipi_design { offsetfile design_name } {
	...
	set system_controller_0 [ create_bd_cell -type ip -vlnv UC3M:user:system_controller:3.0 system_controller_0]
	...
	set offset_file "${bd_path}/system_controller_v3_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef system_controller_v3_0_tb_include_vh_"
	puts $fp "`define system_controller_v3_0_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores UC3M:user:system_controller:3.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/system_controller_v3_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "system_controller_v3_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 system_controller_v3_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top system_controller_v3_0_tb [get_filesets sim_1]
