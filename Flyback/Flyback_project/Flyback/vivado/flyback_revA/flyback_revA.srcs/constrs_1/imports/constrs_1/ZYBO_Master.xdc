...
###################FINAL#############################
#IO_L10P_T1_34
set_property PACKAGE_PIN V15 [get_ports ADC_SCLK]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_SCLK]

#IO_L10N_T1_34
set_property PACKAGE_PIN W15 [get_ports ADC_SDATA]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_SDATA]

#IO_L1P_T0_34
set_property PACKAGE_PIN T11 [get_ports ADC_nCS]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_nCS]
###################FINAL#############################
####################TEST#############################
##IO_L10P_T1_34
#set_property PACKAGE_PIN V15 [get_ports ADC_nCS]
#set_property IOSTANDARD LVCMOS33 [get_ports ADC_nCS]

##IO_L1P_T0_34
#set_property PACKAGE_PIN T11 [get_ports ADC_SDATA]
#set_property IOSTANDARD LVCMOS33 [get_ports ADC_SDATA]

##IO_L1N_T0_34
#set_property PACKAGE_PIN T10 [get_ports ADC_SCLK]
#set_property IOSTANDARD LVCMOS33 [get_ports ADC_SCLK]
####################TEST#############################
#IO_L1N_T0_34
#set_property PACKAGE_PIN T10 [get_ports ADC_SCLK]
...
##IO_L8P_T1_34
#set_property PACKAGE_PIN W14 [get_ports CTRL_START]
#set_property IOSTANDARD LVCMOS33 [get_ports CTRL_START]
...
##Pmod Header JD
##IO_L5P_T0_34
#set_property PACKAGE_PIN T14 [get_ports ADC_START]
#set_property IOSTANDARD LVCMOS33 [get_ports ADC_START]

##IO_L5N_T0_34
#set_property PACKAGE_PIN T15 [get_ports ADC_DONE]
#set_property IOSTANDARD LVCMOS33 [get_ports ADC_DONE]
...
##IO_L11P_T1_SRCC_34
#set_property PACKAGE_PIN U14 [get_ports CTRL_START]
#set_property IOSTANDARD LVCMOS33 [get_ports CTRL_START]

##IO_L11N_T1_SRCC_34
#set_property PACKAGE_PIN U15 [get_ports CTRL_DONE]
#set_property IOSTANDARD LVCMOS33 [get_ports CTRL_DONE]
...
set_property DRIVE 16 [get_ports PWM0]

##IO_L18N_T2_34
set_property PACKAGE_PIN W16 [get_ports VIN_STEP]
set_property IOSTANDARD LVCMOS33 [get_ports VIN_STEP]
set_property DRIVE 16 [get_ports VIN_STEP]

##IO_25_35
set_property PACKAGE_PIN J15 [get_ports LOAD_STEP]
set_property IOSTANDARD LVCMOS33 [get_ports LOAD_STEP]
set_property DRIVE 16 [get_ports LOAD_STEP]

##IO_L19P_T3_35
set_property PACKAGE_PIN H15 [get_ports ADC_START]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_START]

##IO_L3N_T0_DQS_34
set_property PACKAGE_PIN V13 [get_ports ADC_DONE]
set_property IOSTANDARD LVCMOS33 [get_ports ADC_DONE]
