...
HD_PWD='D:/flyback_controller/flyback_controller_v01/flyback_controller_v01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_design_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_design_wrapper.tcl
