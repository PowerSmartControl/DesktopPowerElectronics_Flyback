...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ADC_DONE [ create_bd_port -dir O ADC_DONE ]
  set ADC_SCLK [ create_bd_port -dir O ADC_SCLK ]
  set ADC_SDATA [ create_bd_port -dir I ADC_SDATA ]
  set ADC_START [ create_bd_port -dir O ADC_START ]
  set ADC_nCS [ create_bd_port -dir O ADC_nCS ]
  set LOAD_STEP [ create_bd_port -dir O LOAD_STEP ]
  set PWM0 [ create_bd_port -dir O PWM0 ]
  set VIN_STEP [ create_bd_port -dir O VIN_STEP ]

  # Create instance: Dig_compensator_0, and set properties
  set Dig_compensator_0 [ create_bd_cell -type ip -vlnv gfb:flyback:Dig_compensator:1.0 Dig_compensator_0 ]

  # Create instance: ad7476_IF_0, and set properties
  set ad7476_IF_0 [ create_bd_cell -type ip -vlnv gfb:ip_cores:ad7476_IF:1.0 ad7476_IF_0 ]

  # Create instance: dPWM_0, and set properties
  set dPWM_0 [ create_bd_cell -type ip -vlnv gfb:flyback:dPWM:1.0 dPWM_0 ]
...
CONFIG.PCW_IMPORT_BOARD_PRESET {C:/Users/Gonzalo/Downloads/ZYBO_zynq_def.xml} \
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_controller_0/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins Dig_compensator_0/s_axi_AXILiteS] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net Dig_compensator_0_ap_done [get_bd_pins Dig_compensator_0/ap_done] [get_bd_pins system_controller_0/CTRL_DONE]
  connect_bd_net -net Dig_compensator_0_u [get_bd_pins Dig_compensator_0/u] [get_bd_pins dPWM_0/ref_val]
  connect_bd_net -net SDATA_1 [get_bd_ports ADC_SDATA] [get_bd_pins ad7476_IF_0/SDATA]
  connect_bd_net -net ad7476_IF_0_DATA [get_bd_pins Dig_compensator_0/v_meas] [get_bd_pins ad7476_IF_0/DATA]
  connect_bd_net -net ad7476_IF_0_DONE [get_bd_ports ADC_DONE] [get_bd_pins ad7476_IF_0/DONE] [get_bd_pins system_controller_0/ADC_DONE]
  connect_bd_net -net ad7476_IF_0_SCLK [get_bd_ports ADC_SCLK] [get_bd_pins ad7476_IF_0/SCLK]
  connect_bd_net -net ad7476_IF_0_nCS [get_bd_ports ADC_nCS] [get_bd_pins ad7476_IF_0/nCS]
  connect_bd_net -net dPWM_0_pwm [get_bd_ports PWM0] [get_bd_pins dPWM_0/pwm]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Dig_compensator_0/ap_clk] [get_bd_pins ad7476_IF_0/CLK] [get_bd_pins dPWM_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins system_controller_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins ad7476_IF_0/nRST] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins Dig_compensator_0/ap_rst_n] [get_bd_pins dPWM_0/rstn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins system_controller_0/s00_axi_aresetn]
  connect_bd_net -net system_controller_0_ADC_START [get_bd_ports ADC_START] [get_bd_pins ad7476_IF_0/START] [get_bd_pins system_controller_0/ADC_START]
  connect_bd_net -net system_controller_0_CTRL_START [get_bd_pins Dig_compensator_0/ap_start] [get_bd_pins system_controller_0/CTRL_START]
  connect_bd_net -net system_controller_0_LOAD_STEP [get_bd_ports LOAD_STEP] [get_bd_pins system_controller_0/LOAD_STEP]
  connect_bd_net -net system_controller_0_PWM_ENABLE [get_bd_pins dPWM_0/enable] [get_bd_pins system_controller_0/PWM_ENABLE]
  connect_bd_net -net system_controller_0_VIN_STEP [get_bd_ports VIN_STEP] [get_bd_pins system_controller_0/VIN_STEP]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Dig_compensator_0/s_axi_AXILiteS/Reg] SEG_Dig_compensator_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs system_controller_0/S00_AXI/S00_AXI_reg] SEG_system_controller_0_S00_AXI_reg

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.5.12  2016-01-29 bk=1.3547 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port ADC_DONE -pg 1 -y 370 -defaultsOSRD
preplace port DDR -pg 1 -y 460 -defaultsOSRD
preplace port ADC_START -pg 1 -y 260 -defaultsOSRD
preplace port ADC_SCLK -pg 1 -y 310 -defaultsOSRD
preplace port LOAD_STEP -pg 1 -y 440 -defaultsOSRD
preplace port VIN_STEP -pg 1 -y 420 -defaultsOSRD
preplace port ADC_nCS -pg 1 -y 330 -defaultsOSRD
preplace port ADC_SDATA -pg 1 -y 410 -defaultsOSRD
preplace port PWM0 -pg 1 -y 90 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 480 -defaultsOSRD
preplace inst Dig_compensator_0 -pg 1 -lvl 3 -y 120 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 320 -defaultsOSRD
preplace inst ad7476_IF_0 -pg 1 -lvl 4 -y 340 -defaultsOSRD
preplace inst dPWM_0 -pg 1 -lvl 4 -y 90 -defaultsOSRD
preplace inst system_controller_0 -pg 1 -lvl 3 -y 320 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 270 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 560 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 4 NJ 460 NJ 460 NJ 460 NJ
preplace netloc system_controller_0_LOAD_STEP 1 3 2 NJ 440 NJ
preplace netloc SDATA_1 1 0 4 NJ 410 NJ 410 NJ 410 NJ
preplace netloc system_controller_0_VIN_STEP 1 3 2 NJ 260 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 1 740
preplace netloc system_controller_0_ADC_START 1 3 2 1120 250 NJ
preplace netloc ad7476_IF_0_DONE 1 2 3 810 430 NJ 430 1330
preplace netloc ad7476_IF_0_DATA 1 2 3 790 450 NJ 450 1310
preplace netloc ad7476_IF_0_nCS 1 4 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 400
preplace netloc system_controller_0_PWM_ENABLE 1 3 1 1070
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 -20 230 360
preplace netloc system_controller_0_CTRL_START 1 2 2 780 440 1060
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 3 370 110 750 420 NJ
preplace netloc Dig_compensator_0_ap_done 1 2 1 800
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 480 NJ 480 NJ 480 NJ
preplace netloc Dig_compensator_0_u 1 3 1 N
preplace netloc ad7476_IF_0_SCLK 1 4 1 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 3 380 130 NJ 230 1090
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 -30 220 390 90 770 10 1110
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 730
preplace netloc dPWM_0_pwm 1 4 1 NJ
levelinfo -pg 1 -50 170 580 940 1220 1350 -top 0 -bot 710
",
}
