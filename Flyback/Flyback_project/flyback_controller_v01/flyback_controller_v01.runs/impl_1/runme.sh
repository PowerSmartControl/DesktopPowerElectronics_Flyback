...
HD_PWD='D:/flyback_controller/flyback_controller_v01/flyback_controller_v01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_design_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_design_wrapper.tcl -notrace
